<template>
  ...
  >
    <div class="container">
      <router-link class="navbar-brand" to="/">Vegefoods</router-link>
      <button
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item cta cta-colored">
            <router-link to="/cart" class="nav-link">
              <span class="icon-shopping_cart"></span>[{{ totalQuantity }}]
            </router-link>
          </li>
        </ul>
      </div>
...
export default {
  ...
  setup() {
    ...
    return {
      totalQuantity: computed(() => store.getters["cart/totalQuantity"]),
    };
  },
  data() {
    return {};
